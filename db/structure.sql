...
--
-- Name: vw_cart_items; Type: VIEW; Schema: public; Owner: -
--

CREATE VIEW public.vw_cart_items AS
 SELECT ci.id,
    ci.buyer_id,
    ci.item_id,
    ci.qty,
   ...
   FROM ((((public.cart_items ci
     JOIN public.items ON ((items.id = ci.item_id)))
     JOIN public.colors ON ((colors.id = items.color_id)))
     JOIN public.brands ON ((brands.id = items.brand_id)))
     JOIN public.genders ON ((genders.id = items.gender_id)));
...
--
-- Name: index_cart_items_on_buyer_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_cart_items_on_buyer_id ON public.cart_items USING btree (buyer_id);
...
--
-- Name: index_items_on_description; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_items_on_description ON public.items USING btree (description);


--
-- Name: index_items_on_title_and_seller_id; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX index_items_on_title_and_seller_id ON public.items USING btree (title, seller_id);
...
--
-- Name: index_reviews_on_item_id_and_author_id; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX index_reviews_on_item_id_and_author_id ON public.reviews USING btree (item_id, author_id);
